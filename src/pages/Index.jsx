                                        ...
                                        <div className="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                            <div className="card product-card card-static">
                                                ...
                                                <a
                                                    ...
                                                    href="shop-single-v1.html"
                                                >
                                                    <img src="/assets/img/shop/catalog/26.jpg" alt="Product" />
                                                </a>
                                                <div className="card-body py-2">
                                                    <a
                                                        className="product-meta d-block fs-xs pb-1"
                                        ...
                                        <div className="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                            <div className="card product-card card-static">
                                                ...
                                                <a
                                                    ...
                                                    href="shop-single-v1.html"
                                                >
                                                    <img src="/assets/img/shop/catalog/27.jpg" alt="Product" />
                                                </a>
                                                <div className="card-body py-2">
                                                    <a
                                                        className="product-meta d-block fs-xs pb-1"
                                        ...
                                        <div className="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                            <div className="card product-card card-static">
                                                ...
                                                <a
                                                    ...
                                                    href="shop-single-v1.html"
                                                >
                                                    <img src="/assets/img/shop/catalog/28.jpg" alt="Product" />
                                                </a>
                                                <div className="card-body py-2">
                                                    <a
                                                        className="product-meta d-block fs-xs pb-1"
                                        ...
                                        <div className="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4 d-none d-lg-block">
                                            <div className="card product-card card-static">
                                                ...
                                                <a
                                                    ...
                                                    href="shop-single-v1.html"
                                                >
                                                    <img src="/assets/img/shop/catalog/29.jpg" alt="Product" />
                                                </a>
                                                <div className="card-body py-2">
                                                    <a
                                                        className="product-meta d-block fs-xs pb-1"
                                        ...
                                        <div className="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4 d-none d-lg-block">
                                            <div className="card product-card card-static">
                                                ...
                                                <a
                                                    ...
                                                    href="shop-single-v1.html"
                                                >
                                                    <img src="/assets/img/shop/catalog/30.jpg" alt="Product" />
                                                </a>
                                                <div className="card-body py-2">
                                                    <a
                                                        className="product-meta d-block fs-xs pb-1"
                                        ...
                                        <div className="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4 d-none d-lg-block">
                                            <div className="card product-card card-static">
                                                ...
                                                <a
                                                    ...
                                                    href="shop-single-v1.html"
                                                >
                                                    <img src="/assets/img/shop/catalog/31.jpg" alt="Product" />
                                                </a>
                                                <div className="card-body py-2">
                                                    <a
                                                        className="product-meta d-block fs-xs pb-1"
                                        ...
                                        <div className="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                            <div className="card product-card card-static">
                                                ...
                                                <a
                                                    ...
                                                    href="shop-single-v1.html"
                                                >
                                                    <img src="/assets/img/shop/catalog/32.jpg" alt="Product" />
                                                </a>
                                                <div className="card-body py-2">
                                                    <a
                                                        className="product-meta d-block fs-xs pb-1"
                                        ...
                                        <div className="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                            <div className="card product-card card-static">
                                                ...
                                                <a
                                                    ...
                                                    href="shop-single-v1.html"
                                                >
                                                    <img src="/assets/img/shop/catalog/33.jpg" alt="Product" />
                                                </a>
                                                <div className="card-body py-2">
                                                    <a
                                                        className="product-meta d-block fs-xs pb-1"
                                        ...
                                        <div className="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                            <div className="card product-card card-static">
                                                ...
                                                <a
                                                    ...
                                                    href="shop-single-v1.html"
                                                >
                                                    <img src="/assets/img/shop/catalog/34.jpg" alt="Product" />
                                                </a>
                                                <div className="card-body py-2">
                                                    <a
                                                        className="product-meta d-block fs-xs pb-1"
                                        ...
                                        <div className="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                            <div className="card product-card card-static">
                                                ...
                                                <a
                                                    ...
                                                    href="shop-single-v1.html"
                                                >
                                                    <img src="/assets/img/shop/catalog/35.jpg" alt="Product" />
                                                </a>
                                                <div className="card-body py-2">
                                                    <a
                                                        className="product-meta d-block fs-xs pb-1"
                                                    ...
                                                    <h3 className="product-title fs-sm">
                                                        <a href="shop-single-v1.html">Leather Men’s Sneakers</a>
                                                    </h3>
                                                    <div className="d-flex justify-content-between">
                                                        <div className="product-price">
                                                            <span className="text-accent">
                                        ...
                                        <div className="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4 d-none d-lg-block">
                                            <div className="card product-card card-static">
                                                ...
                                                <a
                                                    ...
                                                    href="shop-single-v1.html"
                                                >
                                                    <img src="/assets/img/shop/catalog/36.jpg" alt="Product" />
                                                </a>
                                                <div className="card-body py-2">
                                                    <a
                                                        className="product-meta d-block fs-xs pb-1"
                                        ...
                                        <div className="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4 d-none d-lg-block">
                                            <div className="card product-card card-static">
                                                ...
                                                <a
                                                    ...
                                                    href="shop-single-v1.html"
                                                >
                                                    <img src="/assets/img/shop/catalog/37.jpg" alt="Product" />
                                                </a>
                                                <div className="card-body py-2">
                                                    <a
                                                        className="product-meta d-block fs-xs pb-1"
                                        ...
                                        <div className="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                            <div className="card product-card card-static">
                                                ...
                                                <a
                                                    ...
                                                    href="shop-single-v1.html"
                                                >
                                                    <img src="/assets/img/shop/catalog/38.jpg" alt="Product" />
                                                </a>
                                                <div className="card-body py-2">
                                                    <a
                                                        className="product-meta d-block fs-xs pb-1"
                                        ...
                                        <div className="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                            <div className="card product-card card-static">
                                                ...
                                                <a
                                                    ...
                                                    href="shop-single-v1.html"
                                                >
                                                    <img src="/assets/img/shop/catalog/39.jpg" alt="Product" />
                                                </a>
                                                <div className="card-body py-2">
                                                    <a
                                                        className="product-meta d-block fs-xs pb-1"
                                        ...
                                        <div className="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4 d-none d-lg-block">
                                            <div className="card product-card card-static">
                                                ...
                                                <div className="card-body py-2">
                                                    ...
                                                    <h3 className="product-title fs-sm">
                                                        <a href="shop-single-v1.html">2-pack Cotton Sun Hats</a>
                                                    </h3>
                                                    <div className="d-flex justify-content-between">
                                                        <div className="product-price">
                                                            <span className="text-accent">
                                        ...
                                        <div className="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                            <div className="card product-card card-static">
                                                ...
                                                <div className="card-body py-2">
                                                    ...
                                                    <h3 className="product-title fs-sm">
                                                        <a href="shop-single-v1.html">Banana Embroidery Cap</a>
                                                    </h3>
                                                    <div className="d-flex justify-content-between">
                                                        <div className="product-price">
                                                            <span className="text-accent">
                                        ...
                                        <div className="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4 d-none d-lg-block">
                                            <div className="card product-card card-static">
                                                ...
                                                <div className="card-body py-2">
                                                    ...
                                                    <h3 className="product-title fs-sm">
                                                        <a href="shop-single-v1.html">Pool Santorini Tankini</a>
                                                    </h3>
                                                    <div className="d-flex justify-content-between">
                                                        <div className="product-price">
                                                            <span className="text-accent">
                ...
                <div className="row">
                    <div className="col-md-3 col-sm-4 col-6">
                        ...
                        >
                            <img
                                ...
                                src="/assets/img/shop/brands/01.png"
                                style={{ width: 150 }}
                                alt="Brand"
                            />
                        </a>
                    ...
                    <div className="col-md-3 col-sm-4 col-6">
                        ...
                        >
                            <img
                                className="d-block mx-auto"
                                src="/assets/img/shop/brands/02.png"
                                style={{ width: 150 }}
                                alt="Brand"
                            />
                        </a>
                    ...
                    <div className="col-md-3 col-sm-4 col-6">
                        ...
                        >
                            <img
                                className="d-block mx-auto"
                                src="/assets/img/shop/brands/03.png"
                                style={{ width: 150 }}
                                alt="Brand"
                            />
                        </a>
                    ...
                    <div className="col-md-3 col-sm-4 col-6">
                        ...
                        >
                            <img
                                className="d-block mx-auto"
                                src="/assets/img/shop/brands/04.png"
                                style={{ width: 150 }}
                                alt="Brand"
                            />
                        </a>
                    ...
                    <div className="col-md-3 col-sm-4 col-6">
                        ...
                        >
                            <img
                                className="d-block mx-auto"
                                src="/assets/img/shop/brands/05.png"
                                style={{ width: 150 }}
                                alt="Brand"
                            />
                        </a>
                    ...
                    <div className="col-md-3 col-sm-4 col-6">
                        ...
                        >
                            <img
                                className="d-block mx-auto"
                                src="/assets/img/shop/brands/06.png"
                                style={{ width: 150 }}
                                alt="Brand"
                            />
                        </a>
                    ...
                    <div className="col-md-3 col-sm-4 col-6">
                        ...
                        >
                            <img
                                className="d-block mx-auto"
                                src="/assets/img/shop/brands/07.png"
                                style={{ width: 150 }}
                                alt="Brand"
                            />
                        </a>
                    ...
                    <div className="col-md-3 col-sm-4 col-6">
                        ...
                        >
                            <img
                                className="d-block mx-auto"
                                src="/assets/img/shop/brands/08.png"
                                style={{ width: 150 }}
                                alt="Brand"
                            />
                        </a>
                    ...
                    <div className="col-md-3 col-sm-4 col-6">
                        ...
                        >
                            <img
                                className="d-block mx-auto"
                                src="/assets/img/shop/brands/09.png"
                                style={{ width: 150 }}
                                alt="Brand"
                            />
                        </a>
                    ...
                    <div className="col-md-3 col-sm-4 col-6">
                        ...
                        >
                            <img
                                className="d-block mx-auto"
                                src="/assets/img/shop/brands/10.png"
                                style={{ width: 150 }}
                                alt="Brand"
                            />
                        </a>
                    ...
                    <div className="col-md-3 col-sm-4 col-6">
                        ...
                        >
                            <img
                                className="d-block mx-auto"
                                src="/assets/img/shop/brands/11.png"
                                style={{ width: 150 }}
                                alt="Brand"
                            />
                        </a>
                    ...
                    <div className="col-md-3 col-sm-4 col-6">
                        ...
                        >
                            <img
                                className="d-block mx-auto"
                                src="/assets/img/shop/brands/12.png"
                                style={{ width: 150 }}
                                alt="Brand"
                            />
                        </a>
